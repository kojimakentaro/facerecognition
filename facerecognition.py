...
Original file is located at
    https://colab.research.google.com/drive/1ASfnTS8WP4hnC2-zm9FJHtkLFQ2dpNfB
"""
...
face_recognitions = face_recognition.face_locations(image)
face_recognitions
...
image2 = face_recognition.load_image_file("ダウンロード.png")
